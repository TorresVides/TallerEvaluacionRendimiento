...
# Fichero:   lanzadorCOpenMP.pl
# Descripcion:
#    Script Perl que automatiza la ejecucion por lotes de mmClasicaOpenMP, probando combinaciones de tamanos de matriz y hilos OpenMP para estudiar el rendimiento.
#-------------------------------------------------------------------------------
